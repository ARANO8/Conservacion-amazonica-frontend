...
import { EditarCuadroClientWrapper } from './client-wrapper';

interface EditarCuadroPageProps {
  params: Promise<{ id: string }>;
}

export default async function EditarCuadroPage({
  params,
}: EditarCuadroPageProps) {
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-xs">
              Compras y Servicios — actualiza la comparación de cotizaciones.
            </p>
          </div>
        </div>
      </div>

      <EditarCuadroClientWrapper cuadroId={id} />
    </div>
  );
}
