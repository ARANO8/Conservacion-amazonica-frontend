        ...
        <FieldGroup>
          ...
          <FieldSet>
            ...
            <div className="grid grid-cols-1 gap-3 text-sm md:grid-cols-13">
              ...
              <div className="text-muted-foreground md:col-span-2">Destino</div>
                  ...
                  >
                    ...
                    <ComboboxContent>
                      <ComboboxList>
                        ...
                        <ComboboxItem value="movilidad">Movilidad</ComboboxItem>
                      </ComboboxList>
                    </ComboboxContent>
                  </Combobox>
                </Field>
                ...
                <Field className="md:col-span-1">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setTravelRows((prev) =>
                        prev.map((r, i) =>
                          i === idx ? { ...r, dias: Number(e.target.value) } : r
                        )
                      )
                    }
                  />
