...
export default function InformeActividadesForm({
  ...
  const handleRangeChange = (range: DateRange | undefined) => {
    ...
    form.setValue('fechaInicio', toInputDate(from), {
      shouldDirty: true,
      shouldValidate: true,
    });
    form.setValue('fechaFin', toInputDate(normalizedTo), {
      shouldDirty: true,
      shouldValidate: true,
    });
  };
  ...
  // Sin esto, un rechazo de zod dejaría la pantalla muda: los errores de
  // arreglo (rango y "al menos una actividad") no tienen dónde mostrarse.
  const onInvalid = () => {
      ...
      >
        ...
        <div className="flex justify-end gap-3">
          ...
          <Button type="submit" disabled={saving}>
            ...
            {isEdit ? 'Guardar cambios' : 'Registrar informe'}
          </Button>
        </div>
      </form>
    </Form>
